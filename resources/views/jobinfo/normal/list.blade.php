                    ...
                    <table class="member-list in-input table-2x-large table_pc">
                        ...
                        @forelse($lists as $list)
                            <tr>
                                ...
                                <td class="td_homepage visible-pc">{{ get_recommend_screening_method_lists($list->screening_method) }}</td>
                                <td class="td_workArea">{{ get_work_area_lists($list->work_area) }}</td>
