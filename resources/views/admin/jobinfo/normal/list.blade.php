...
@section("content")
    ...
    <section id="" class="list_wrapper">
            ...
            <div class="head-info">
                ...
                <div class="action-wrap">
                    <ul>
                        ...
                        <li>
                            <button class="btn-black-middle" id="btnexcel" data-name="엑셀" data-url="/download/jobinfo/normal">엑셀출력</button>
                        </li>
                        <li>
        ...
        <article class="table03">
            <form action="" method="post" name="forms" data-route="/{{ ADMIN_URL }}/jobinfo/normal">
                @csrf
                @method("delete")
                <table>
                    <colgroup>
                    ...
                    @forelse($lists as $list)
                        <tr>
                            ...
                            <td class="text_left_wrap"><a href="/{{Route::current()->uri . '/'. $list->id }}/edit"><p>{{ $list->recruitment_field }}</p></a></td>
