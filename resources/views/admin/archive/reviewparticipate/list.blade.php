...
@section("content")
    ...
    <section id="" class="list_wrapper">
            ...
            <div class="head-info">
                ...
                <div class="action-wrap">
                    <ul>
                        ...
                        <li>
                            <button class="btn-black-middle" id="btnexcel" data-name="엑셀" data-url="/download/archive/reviewparticipate">엑셀출력</button>
                        </li>
                        <li>
        ...
        <article class="table03">
            <form action="" method="post" name="forms" data-route="/{{ ADMIN_URL }}/archive/reviewparticipate">
                @csrf
                @method("delete")
                <table>
                    <colgroup>
