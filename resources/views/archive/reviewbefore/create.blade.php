...
@section("content")
    ...
    <div class="sub-content">
        ...
        <div class="board-wrap board-create">
            <form action="/archive/reviewbefore/{{ isset($list) ? $list -> id.'/update' : 'store' }}" method="post" name="forms" data-route="/archive/reviewbefore" onsubmit="return archive_validate(this);" enctype="multipart/form-data">
                @csrf
                @if (isset($list))
                    @method("put")
                ...
                <div class="table02-create table02 table-agree">
                    ...
                    <table>
                        ...
                        <tbody>
                        <tr>
                            <th class="text-subject w167">개인정보 수집·이용·제공 동의서</th>
                        </tr>
                        <tr>
                            <td>
                ...
                <div class="btn-wrap create-btn">
                    ...
                    @endif
                    <a href="/archive/reviewbefore" class="btn-cancel btn02">취소</a>
