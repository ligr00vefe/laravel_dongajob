...
@section("content")
    ...
    <div class="sub-content">
        <div class="sub-content_title">
            <h1>최신 취업수기 {{ isset($list) ? '수정' : '등록' }}</h1>
        </div>

        <div class="board-wrap board-create">
            <form action="/archive/reviewlatest/{{ isset($list) ? $list -> id.'/update' : 'store' }}" method="post" onsubmit="return archive_validate(this);" enctype="multipart/form-data">
                @csrf
                @if (isset($list))
                    @method("put")
                        ...
                        <tr>
                            <td>
                                <span class="text-content">
                                    <p>
                                        1. 개인정보의 수집·이용 목적 : 최신취업수기 관련 개별 연락 및 확인, 통계자료 활용 <br/>
                ...
                <div class="btn-wrap create-btn">
                    <a href="/archive/reviewlatest" class="btn-cancel btn02">취소</a>
