            ...
            <div class="view-bottom">
                <div class="btn-others">
                    <a href="" class="prev-view switch-view-page">
                        <span class="prev-icon switch-view-icon"><img src="http://{{$_SERVER['HTTP_HOST']}}/img/prev_view_icon.png" alt="이전글 아이콘"><b>이전글</b></span>
                    ...
                    <a href="" class="next-view switch-view-page">
                        <span class="next-icon switch-view-icon"><img src="http://{{$_SERVER['HTTP_HOST']}}/img/next_view_icon.png" alt="다음글 아이콘"><b>다음글</b></span>
                        <span class="switch-view-subject">(주)화승알엔에이</span>
                        <span class="switch-view-datetime">20-09-06</span>
                    </a>
                </div>{{-- //.btn-others end --}}
