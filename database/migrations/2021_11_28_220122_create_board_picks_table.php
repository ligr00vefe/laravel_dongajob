...
class CreateBoardPicksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('board_picks', function (Blueprint $table) {
            $table->id();
            $table->string('company_name')->comment('기업명');
            $table->string('recruitment_field')->comment('채용공고');
    ...
    {
        Schema::dropIfExists('board_picks');
    }
}
