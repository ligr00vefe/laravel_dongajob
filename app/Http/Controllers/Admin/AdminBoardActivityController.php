...
class AdminBoardActivityController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return View('admin.jobinfo.activity.list', [
            "lists" => $lists,
            'count' => count($lists),
            'search' => $search,
    ...
    public function view($id)
    {
        ...
        return View('admin.jobinfo.activity.view', ['list' => $list]);
    }
    ...
    {
        return View('admin.jobinfo.activity.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($write)
        {
            return redirect()->route("admin.jobinfo.activity.index")->with("success", msg_collection('success_enrollment'));
        }
        else
        {
    ...
    public function destroy(Request $request)
    {
        if (isset($request->id)) {
            ...
            if ($delete) {
                ...
                return redirect()->route("admin.jobinfo.activity.index")->with("success", msg_collection('success_remove'));
            }else
            {
    ...
    public function destroyAll(Request $request)
    {
        ...
        if ($chk)
            return redirect()->route("admin.jobinfo.activity.index")->with("success", "정상적으로 삭제되었습니다.");
