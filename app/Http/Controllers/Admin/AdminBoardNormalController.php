...
class AdminBoardNormalController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return View('admin.jobinfo.normal.list', [
            "lists" => $lists,
            'search' => $search
        ]);
    ...
    {
//        $get = DB::table('board_normal')
//            ->where("id", "=", $id)
//            ->first();

        return View('admin.jobinfo.normal.view');
    ...
    {
        return View('admin.jobinfo.normal.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($write)
        {
            return redirect()->route("admin.jobinfo.normal.index")->with("success", msg_collection('success_enrollment'));
        }
        else
        {
    ...
    public function destroy(Request $request)
    {
        if (isset($request->id)) {
            ...
            if ($delete) {
                ...
                return redirect()->route("admin.jobinfo.normal.index")->with("success", msg_collection('success_remove'));
            }else
            {
    ...
    public function destroyAll(Request $request)
    {
        ...
        if ($chk)
            return redirect()->route("admin.jobinfo.normal.index")->with("success", "정상적으로 삭제되었습니다.");
