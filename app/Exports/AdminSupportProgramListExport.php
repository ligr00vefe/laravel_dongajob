...
class AdminSupportProgramListExport implements FromView, WithColumnWidths
{
    protected $id;
    ...
    public function view(): View
    {
        ...
        return view("admin._excel.support.program.list", ["heads" => $heads, "contents" => $contents, 'applicant_lists' => $applicant_lists,
            'waiting_lists' => $waiting_lists, "index" => 1]);
    }
