...
use App\Uploads\ReviewLatestAttachment;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Request;

class ReviewLatest extends Boards
{
    // 테이블명, 필수
    protected string $table = "board_review_latests";
    ...
    {
        $this->attachmentTable = new ReviewLatestAttachment();
        $this->insert($request);
        return $this->getId();
    }
