...
use App\Uploads\ReviewParticipateAttachment;
use Illuminate\Support\Facades\Request;

class ReviewParticipate extends Boards
{
    // 테이블명, 필수
    protected string $table = "board_review_participate";
    ...
    protected array $attachments = [ "attachment1", "attachment2" ];
    ...
    {
        $this->attachmentTable = new ReviewParticipateAttachment();
            $this->insert($request);
            return $this->getId();
    }
