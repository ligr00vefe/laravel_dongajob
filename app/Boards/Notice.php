...
class Notice extends Boards
{
    ...
    protected array $columns = [
        "user_id", "status_id", "category_id", "subject", "schedule_date", "hit", "content",
    ...
    {
        $this->attachmentTable = new NoticeAttachment();
            $this->insert($request);
            return $this->getId();
    }
    ...
    public static function import_by_category($request): array
    {
        ...
        foreach ($category_list as $key => $val) {
            ...
            $list[$key] = DB::table("board_notices")
