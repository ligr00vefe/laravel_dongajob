...
class Interview extends Boards
{
    // 테이블명, 필수
    protected string $table = "board_interviews";

    // 프론트->백으로 넘어올 input name값. 반드시 디비의 컬럼명과 동일해야함, 필수
    // 여기에 정의 안되면 디비에 안들어감
    protected array $columns = [
        "enterprise", "category", "support_division", "support_job",
        "next_round", "next_round_schedule", "user_id", "contents"
    ];
