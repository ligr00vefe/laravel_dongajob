...
class ActivityAttachment extends ATTACHMENT
{
    protected $filenames = [ "attachment1", "attachment2", "attachment3", "attachment4", "attachment5" ];
    protected $from = "각종 활동";
    protected $upload_path = "activity";
    protected $exts = [ "jpg", "png", "jpeg", "svg", "gif","pdf", "zip", "doc", "docx", "avi", "mp4", "mov", "wmv", "pptx", "hwp", "csv", "txt", "xls", "xlsx","hwpx"];
